        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(u.first_name, ". Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE users SET first_name = $2, last_name = $3, password = $4 WHERE id = $1 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [
                                u.id,
                                u.first_name,
                                u.last_name,
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not update user ".concat(u.id, ". Error: ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not delete user ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
